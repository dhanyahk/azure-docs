...
You can get the list of all Audit Activities using the Graph API [Audit Activity API] (https://graph.windows.net/$tenantdomain/activities/auditActivityTypes?api-version=beta), where $tenantdomain = your domain name or,

Refer to the article [audit report events](active-directory-reporting-audit-events.md#list-of-audit-report-events).
